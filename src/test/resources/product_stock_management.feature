Feature: Product Stock Management
  ...
  Scenario: Update product stock to low level
  ...
  Scenario Outline: Check stock status for different scenarios
    ...
    Examples:
      | current_stock | min_stock | low_stock_expected | out_of_stock_expected |
      | 0             | 5         | false              | true                  |
      | 3             | 10        | true               | false                 |
      | 15            | 10        | false              | false                 |
      | 10            | 10        | true               | false                 |